...
def login():
    if request.method == "POST":
        ...
        get_image(takendataURL, username, r'/Face_images/')
        path_for_image = os.path.dirname(os.path.abspath(__file__))
        path_for_image += r'/Verify_face/' + username + '.png'
        ...
        if key != 'False':
            if Password_work.decrypt('dtfyuhgfcyhugfdxgyhty678yutre567uyhgtfrde456ytfdre54678iuygtfr56t78uijhgty67890poi8967tyuio876rtfghuio87y6t5rtyui8y76t54ertfyguhy76t54e3erdfghjui7y6t54eerdfghui87654ertfghui8y7654ersdfghjui876rtyghio98765rtyui87y6t5ertyuio8uy76t5rrefghuio8u7y', 'test', str(key), username, password) != False:
                session["password"] = password
